...
//
// DESCRIPTION
// This class is the main class that stores information for a student.  Contains lastName, firstName, fullName
// and two ArrayLists of integers storing homework and exam scores
//
// AUTHOR
//Steven Kosanke
//skosanke
...
public class Student implements Comparable<Student> {
    ...
    public int compareTo(Student pStudent) {
    	Student a = this; String aName = a.getLastName();
    	Student b = pStudent; String bName = b.getLastName();
    ...
    public int getExam(int pNum) {
    	ArrayList <Integer> tempExam = new ArrayList<Integer> ();
    	tempExam = getHomeworkList();
    	return tempExam.get(pNum);
    }
    ...
    public int getHomework(int pNum) {
    	ArrayList <Integer> tempHomework = new ArrayList<Integer> ();
    	tempHomework = getHomeworkList();
    	return tempHomework.get(pNum);
     ...
     */
    public void setExam(int pNum, int pValue) {
    	ArrayList <Integer> tempExam = new ArrayList<Integer> ();
    	tempExam = getExamList();
    	tempExam.set(pNum, pValue);
    	setExamList(tempExam);
    }
     ...
     * to set the value in the ArrayList<Integer> at index 'index' to 'value'.
     */
    public void setHomework(int pNum, int pValue) {
    	ArrayList <Integer> tempHomework = new ArrayList<Integer> ();
    	tempHomework = getHomeworkList();
    	tempHomework.set(pNum, pValue);
    	setHomeworkList(tempHomework);
    }
