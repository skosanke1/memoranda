...
public class CheckersTest {
    ...
    CheckersLogic testB;
    	...
    	/**
    	 * Setup method to create checkerboards, computer players, and predetermined test moves
    	 * 
	...
	/**
	 * Tear down method to dispose of all initiated objects
	 * 
	 * @throws java.lang.Exception Throws general exception
	 */
	@AfterClass
	...
	/**
	 * Test for getTurn method of CheckersLogic Class
	 */
	@Test
    public void getTurn() {  
        testA.move(moveX1);
	...
	/**
	 * Test for move method of CheckersLogic Class
	 */
    @Test
    public void move() {
        //Cases should fail
	...
	/**
	 * Test for displayGame method of CheckersLogic Class
	 */
    @Test
	...
	/**
	 * Test for winCheck method of CheckersLogic Class
	 */
    @Test
...
//END OF TESTS FOR CHECKERSLOGIC CLASS
	...
	/**
	 * Test for getNextMove method of CheckersComputerPlayer Class
	 */
   @Test
   public void getNextMove() {
       ...
       //Also included some statements that should not work
       assertFalse(comp.getNextMove().equals("String"));
       assertFalse(comp.getNextMove().equals(compO3));
       assertFalse(comp.getNextMove().equals(compO1));
