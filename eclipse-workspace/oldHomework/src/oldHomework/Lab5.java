...
/*-------------------------------------------------------------
  ...
  // SPECIFICATION: Creates rows, pyramids, and diamonds of user declared size
  // FOR: CSE 110-Lab #5
  // TIME SPENT: 3 hours 
//-----------------------------------------------------------*/
...
public class Lab5 {
    ...
    private static String buildDiamond(
        ...
        if (totalSymbOneRow % 2 == 0){
        	totalSymbOneRow = totalSymbOneRow - 1;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            case 'r':
                ...
                String x = buildRow(SIDE_SYMB, sideWidth, MID_SYMB , midWidth);
