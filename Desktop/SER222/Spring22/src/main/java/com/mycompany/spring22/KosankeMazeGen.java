...
package com.mycompany.spring22;//REMOVE BEFORE TURNIN
import java.util.Random;

public class KosankeMazeGen {  //SWITCH BEFORE TURN IN
    //public class ser222_01_01_hw02_base
/**
 * Program that can generate a maze recursively
 *
 ...
 */
    ...
    private static void makeMazeRecursive(char[][]level, int startX, int startY, int endX, int endY)
    {
        ...
        //(A,B) represents the intersection, colmn/row
       // section 1 = (startX, startY) (A, B) section 2 = (A, startY) (endX, B)
       // section 3 = (startX, B) (A, endY) section 4 = (A, B) (endX, endY)

                makeMazeRecursive(level,  startX, startY, A, B);
                makeMazeRecursive(level, A, startY, endX, B);
                makeMazeRecursive(level, startX, B, A, endY);
                makeMazeRecursive(level, A, B, endX, endY);
